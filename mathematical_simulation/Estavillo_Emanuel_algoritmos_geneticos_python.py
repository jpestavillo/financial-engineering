...
def imprimir():
    ...
    print("codigo propiedad de estavillo y emanuel")
...
#%%
#for w in range (0,n):
 #   estavilloyemma[w,0]=(bi[convertirbinario,columna]*512)+(bi[convertirbinario,1]*256)+(bi[convertirbinario,2]*128)+(bi[convertirbinario,3]*64)+(bi[convertirbinario,4]*32)+(bi[convertirbinario,5]*16)+(bi[convertirbinario,6]*8)+(bi[convertirbinario,7]*4)+(bi[convertirbinario,8]*2)+(bi[convertirbinario,9]*1)
    
#%%
    #aqui tomamos los mas aptos para la pelea
